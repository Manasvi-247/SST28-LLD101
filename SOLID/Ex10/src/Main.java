public class Main {
    public static void main(String[] args) {
        ...
        DriverAllocatable allocator = new DriverAllocator();
        PaymentChargeable gateway = new PaymentGateway();

        TransportBookingService svc = new TransportBookingService(distCalc, allocator, gateway);
        svc.book(req);
    }
}
